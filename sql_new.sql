...
ALTER TABLE Uzyte_czesci ADD CONSTRAINT Uzyte_czesci_fk0 FOREIGN KEY (ID_Naprawy) REFERENCES Naprawa(ID_Naprawy);
...
ALTER TABLE Faktura ADD CONSTRAINT Faktura_fk2 FOREIGN KEY (ID_Naprawy) REFERENCES Naprawa(ID_Naprawy);
